...
import { Atom, Beaker, BookOpen, Bot, Sparkles } from 'lucide-react';
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="min-h-screen bg-background transition-colors duration-500">
        <div className="relative container mx-auto py-12 px-4 z-10">
          ...
          <section className="mb-20 bg-card rounded-3xl p-8 md:p-12 border border-border">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                ...
                molecular structures, and complex concepts through natural conversation.
              </p>
              
              <Button 
                onClick={() => setShowBot(true)}
                size="lg"
                className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-primary/20"
              >
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
            <div className="xl:col-span-3 bg-card rounded-3xl shadow-lg border border-border p-8">
        ...
        {showBot && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-md">
            <div className="w-full max-w-5xl h-[85vh] bg-card rounded-3xl shadow-2xl overflow-hidden border border-border">
