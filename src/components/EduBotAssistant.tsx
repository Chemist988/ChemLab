    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 shadow-2xl hover:shadow-3xl transition-all duration-500 flex items-center justify-center border border-purple-400/30 backdrop-blur-xl"
        >
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-purple-100 text-sm">Your intelligent chemistry companion for NCERT Class 10</p>
                </div>
              </div>
              <Button
