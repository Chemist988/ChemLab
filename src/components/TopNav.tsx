...
const TopNav = () => {
  ...
  return (
    <nav className={cn(
      ...
      scrolled 
        ? "glass-morphism border-b-2 border-green-400/40 shadow-2xl" 
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-3xl font-black font-orbitron bg-gradient-to-r from-green-400 via-green-300 to-green-500 bg-clip-text text-transparent group-hover:scale-105 transition-transform duration-300">
              ChemLab
            </span>
          </Link>
            ...
            {navItems.map(({ path, icon: Icon, label }) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(path)
                    ? 'glass-morphism text-green-400 shadow-2xl border-2 border-green-400/40 scale-105'
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="md:hidden">
              <button className="glass-morphism p-2 rounded-xl border border-green-400/30 text-green-400 hover:bg-green-500/20 transition-all duration-300">
            ...
            {navItems.map(({ path, icon: Icon, label }) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(path)
                    ? 'glass-morphism text-green-400 border border-green-400/40'
